...
% Last Modified by GUIDE v2.5 17-May-2016 12:52:17
...
function inputAxes_CreateFcn(hObject, eventdata, handles)
% hObject    handle to inputAxes (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate inputAxes
set(gca,'xtick',[],'ytick',[]);
